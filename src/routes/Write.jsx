  ...
  return (
    <div className='h-[calc(100vh-64px)] md:h-[calc(100vh-80px)] flex flex-col gap-6'>
      ...
      <form className="flex flex-col gap-6 flex-1 mb-6">
        ...
        <input className="text-4xl font-semibold bg-transparent outline-none" type='text' placeholder='Enter the title'/>
        ...
        <textarea name='desc' placeholder='Short Description' className="p-4 rounded-xl bg-white shadow-md"/>
